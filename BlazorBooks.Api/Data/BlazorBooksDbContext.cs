    ...
    public class BlazorBooksDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Book>().HasData(new Book
            {
                ...
                DatePublished = DateTime.Parse("1997"),
            ...
            modelBuilder.Entity<Book>().HasData(new Book
            {
                ...
                DatePublished = DateTime.Parse("10/16/2018"),
                Language = Enums.Language.English,
                CountPages = 320,
                Price = 100,
                GenreId = 1
            ...
            modelBuilder.Entity<Book>().HasData(new Book
            {
                ...
                DatePublished = DateTime.Parse("04/2016"),
                Language = Enums.Language.English,
                CountPages = 208,
                Price = 100,
                GenreId = 1
            ...
            modelBuilder.Entity<Book>().HasData(new Book
            {
                ...
                DatePublished = DateTime.Parse("1926"),
                Language = Enums.Language.English,
                CountPages = 100,
                Price = 100,
                GenreId = 1
            ...
            modelBuilder.Entity<Book>().HasData(new Book
            {
                ...
                DatePublished = DateTime.Parse("04/1986"),
                Language = Enums.Language.English,
                CountPages = 448,
                Price = 11.99M,
                GenreId = 2
            ...
            modelBuilder.Entity<Book>().HasData(new Book
            {
                ...
                DatePublished = DateTime.Parse("1990"),
                Language = Enums.Language.English,
                CountPages = 400,
                Price = 11.99M,
                GenreId = 2
            ...
            modelBuilder.Entity<Book>().HasData(new Book
            {
                ...
                DatePublished = DateTime.Parse("2011"),
            ...
            modelBuilder.Entity<Book>().HasData(new Book
            {
                ...
                DatePublished = DateTime.Parse("2008"),
                Language = Enums.Language.English,
                CountPages = 130,
                Price = 63.73M,
                GenreId = 3
            ...
            modelBuilder.Entity<Book>().HasData(new Book
            {
                ...
                DatePublished = DateTime.Parse("2017"),
                Language = Enums.Language.English,
                CountPages = 152,
                Price = 63.73M,
                GenreId = 3
            ...
            modelBuilder.Entity<Book>().HasData(new Book
            {
                ...
                DatePublished = DateTime.Parse("01/28/2020"),
                Language = Enums.Language.English,
                CountPages = 128,
                Price = 16.30M,
                GenreId = 4
